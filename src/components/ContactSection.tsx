  ...
  return (
    <section id="contact" className="py-16 sm:py-24 bg-muted">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-lg sm:text-xl text-center text-muted-foreground/90 mb-12 max-w-3xl mx-auto">
          Ready to transform your virtual health strategy?
        </p>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-6 max-w-3xl mx-auto">
          {/* Contact Links */}
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-muted-foreground/80 hover:text-secondary transition-colors"
                >
